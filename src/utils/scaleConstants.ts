...
export const KIND_BY_LABEL: Array<{ test: RegExp; k: KindUnit }> = [
  ...
  // --- Biological ---
  { test:/^Breaths$/i,                        k:R({ kind:"count", unit:"breaths" }) },
  { test:/^Air inhaled \(Liters\)$/i,         k:R({ kind:"count", unit:"L" }) },
  { test:/^Blinks$/i,                         k:R({ kind:"count", unit:"blinks" }) },
  { test:/^Heartbeats$/i,                     k:R({ kind:"count", unit:"heartbeats" }) },
  { test:/^Blood pumped \(Liters\)$/i,        k:R({ kind:"count", unit:"L" }) },
  { test:/^Dead and replaced cells$/i,        k:R({ kind:"count", unit:"cells" }) },
  ...
  { test:/^Toilet visits$/i,                  k:R({ kind:"count", unit:"visits" }) },
  { test:/^Dog years$/i,                      k:R({ kind:"count", disableOverlay:true }) },

  // --- Everyday ---
  { test:/^Steps taken$/i,                    k:R({ kind:"count", unit:"steps" }) },
  { test:/^Kilometers walked$/i,              k:R({ kind:"count", unit:"km" }) },
  { test:/^Showers$/i,                        k:R({ kind:"count", unit:"showers" }) },
  { test:/^Songs played$/i,                   k:R({ kind:"count", unit:"songs" }) },
  { test:/^Words spoken$/i,                   k:R({ kind:"count", unit:"words" }) },
  { test:/^Curses spoken$/i,                  k:R({ kind:"count", unit:"curses" }) },
  { test:/^Laughs$/i,                         k:R({ kind:"count", unit:"laughs" }) },
  { test:/^Sneezes$/i,                        k:R({ kind:"count", unit:"sneezes" }) },
  { test:/^Yawns$/i,                          k:R({ kind:"count", unit:"yawns" }) },

  // --- Nerdy ---
  { test:/^Smartphone unlocks$/i,             k:R({ kind:"count", unit:"unlocks" }) },
  { test:/^Photos taken$/i,                   k:R({ kind:"count", unit:"photos" }) },
  { test:/^Videos taken$/i,                   k:R({ kind:"count", unit:"videos" }) },
  { test:/^Keystrokes$/i,                     k:R({ kind:"count", unit:"keystrokes" }) },
  { test:/^Mouse clicks$/i,                   k:R({ kind:"count", unit:"clicks" }) },
  { test:/^Notifications$/i,                  k:R({ kind:"count", unit:"notifications" }) },
  ...
  // --- Cosmic ---
  { test:/^Sun equatorial rotations$/i,       k:R({ kind:"count", unit:"rotations" }) },
  { test:/^Lunar cycles$/i,                   k:R({ kind:"count", unit:"cycles" }) },
  ...
  { test:/^Halley comet orbits$/i,            k:R({ kind:"count", unit:"orbits" }) },
